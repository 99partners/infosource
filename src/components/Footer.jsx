    ...
    <footer className="relative overflow-hidden border-t border-white/10">
      ...
      <div className="relative z-10 mx-auto px-6 py-16 bg-gradient-to-br from-primary/10 via-secondary/10 to-accent/10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          ...
          <div>
            <h3 className="font-semibold mb-4 text-foreground">Our Domains</h3>
            <ul className="space-y-2">
              <li><a href="https://99partners.in/" target="blank" className="text-muted-foreground hover:text-primary transition-colors duration-300 ease-in-out block py-1">99partners.in</a></li>
              <li><a href="https://99digicom.com/" target="blank" className="text-muted-foreground hover:text-primary transition-colors duration-300 ease-in-out block py-1">99digicom.com</a></li>
              <li><a href="https://99finserv.com/" target="blank" className="text-muted-foreground hover:text-primary transition-colors duration-300 ease-in-out block py-1">99finserv.com</a></li>
              <li><a href="#" className="text-muted-foreground hover:text-primary transition-colors duration-300 ease-in-out block py-1">harmonyhights.com</a></li>
            </ul>
          </div>
          <div>
            <h3 className="font-semibold mb-4 text-foreground">Contact</h3>
