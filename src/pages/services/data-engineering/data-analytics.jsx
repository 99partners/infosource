    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <span className="text-sm font-medium text-blue-500 font-sans">Data Analytics Services</span>
        </div>
        <h1 className={`text-5xl md:text-7xl font-bold mb-6 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} text-black font-sans`}>
          Harness <span className="text-blue-500 relative">Data Analytics<div className="absolute -bottom-2 left-0 w-full h-1 bg-blue-500 rounded-full transform scale-x-0 animate-[scale-x_1s_ease-out_1s_forwards]"></div></span>
        </h1>
        <p className={`text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} font-sans`}>
          Harness the strength of Data Analytics to convert knowledge into planned expansion. Our offerings streamline activities, improve client interactions, and increase income.
        </p>
        <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <Button variant="glass" size="xl" className="group bg-black/10 text-blue-500 hover:text-blue-600 font-sans">
            <Play className="w-5 h-5 group-hover:text-blue-600 transition-colors" />Discover More on Data Analytics
          </Button>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Our <span className="text-blue-500">Data Analytics</span> Offerings
          </h2>
          <p className={`text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Our Data and Analytics offerings transform unprocessed data into concrete enterprise worth, streamlining activities and driving growth.
          </p>
        </div>
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {[
            { icon: BarChart3, text: "Data Evaluation and Reporting: Convert data into practical views via sophisticated analytics and enterprise patterns." },
            { icon: LineChart, text: "Predictive Analytics: Employ advanced formulas and machine learning to predict upcoming patterns and actions." },
            { icon: Database, text: "Descriptive Analytics: Review past data to grasp performance and reveal patterns, offering a distinct business perspective." },
            { icon: Settings, text: "Prescriptive Analytics: Suggest ideal actions drawn from data-based forecasts, refining choices and processes." },
            { icon: Search, text: "Diagnostic Analytics: Reveal causes of problems and patterns, supporting resolution and choice making." }
          ].map((point, index) => {
...
const TechStackSection = () => {
  ...
  const technologies = [
    { icon: Database, title: "Data Gathering and Merging", color: "from-blue-500 to-blue-700" },
    { icon: Settings, title: "Data Handling and Change", color: "from-green-500 to-green-700" },
    { icon: BarChart3, title: "Data Evaluation and Modeling", color: "from-purple-500 to-purple-700" },
    { icon: Eye, title: "Data Display", color: "from-red-500 to-red-700" },
    { icon: FileText, title: "Reporting and Panels", color: "from-indigo-500 to-indigo-700" },
    { icon: Shield, title: "Data Handling and Oversight", color: "from-blue-500 to-blue-700" },
    { icon: Cloud, title: "Data Merging and APIs", color: "from-green-500 to-green-700" },
    { icon: Zap, title: "Data Automation", color: "from-purple-500 to-purple-700" }
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Empowering <span className="text-blue-500">Data Analytics</span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Our sophisticated tech collection provides precise, practical, and data-oriented Data Analytics offerings.
          </p>
        </div>
...
const ProcessSection = () => {
  ...
  const processes = [
    { icon: Target, title: "Outlining Aims", description: "Distinctly define the particular queries or aims to examine the goals to resolve." },
    { icon: Database, title: "Gathering Data", description: "Collect pertinent data from diverse origins in an organized form." },
    { icon: AlertTriangle, title: "Purifying Data", description: "Spot and fix mistakes, absent values, and discrepancies in the data sheet." },
    { icon: BarChart3, title: "Evaluating Data", description: "Use statistical and machine learning methods to spot patterns and trends." },
    { icon: CheckCircle, title: "Interpreting Data", description: "Change understanding into applicable suggestions based on results." }
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Effective <span className="text-blue-500">Data Analytics</span> Process
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <div className="text-center bg-gradient-to-r from-blue-800 to-blue-400 rounded-2xl p-8 text-white">
          ...
          <p className="text-lg mb-6 font-sans">Review our notable Data Analytics case studies</p>
          <p className="text-blue-100 mb-8 font-sans">Observe how we promote enterprise expansion across industries.</p>
...
const WhyChooseSection = () => {
  ...
  const features = [
    { icon: Target, title: "Sophisticated Data Modeling", description: "Sophisticated formulas and statistical methods to forecast patterns and form knowledgeable choices." },
    { icon: Eye, title: "Thorough Data Display", description: "Change intricate data into clear visual form for improved planned preparation." },
    { icon: Shield, title: "Data-Driven Results", description: "Unlock data's complete potential with precise and actionable insights." },
    { icon: Heart, title: "Client-Centric Approach", description: "Your data, our skills, and outstanding results as your trusted partner." }
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Unlock data's complete potential with Infosource, your trusted Data Analytics firm.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
            Discover how Infosource’s Data Analytics solutions drive enterprise expansion across industries.
          </p>
        </div>
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-8 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {[
            { icon: Star, title: "Case Studies", description: "Review our notable Data Analytics case studies and observe how we promote enterprise expansion.", buttonText: "View Our Case Studies" },
            { icon: TrendingUp, title: "Industries", description: "Data Analytics achievements across sectors, transforming enterprises with knowledge.", buttonText: "Arrange a Complimentary AI Discussion" },
            { icon: Users, title: "Testimonials", description: "Our clients express how Infosource’s Data Analytics offerings have changed enterprises.", buttonText: "Our Clients Express for Us" },
            { icon: CheckCircle, title: "Resources", description: "Review specialist pieces, patterns, and advice to master Data Analytics.", buttonText: "Access Data Analytics Blogs" }
          ].map((item, index) => {
