  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          Modernize your workflows, reduce errors, and boost efficiency with Infosource’s DevOps automation solutions.
        </p>
        <div
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center bg-gradient-to-r from-blue-800 to-blue-400 rounded-2xl p-8 text-white">
          ...
          <p className="text-lg mb-6 font-sans">
            Discover how our DevOps automation has transformed businesses.
          </p>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white font-sans">
            Transforming <span className="text-blue-200">Businesses</span> with DevOps Automation
          </h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
            Discover how our DevOps automation has transformed businesses across industries.
          </p>
        </div>
        <div
        ...
        >
          {[
            ...
            },
            {
              ...
              title: "Testimonials",
              description:
                "Learn how our DevOps automation has impacted clients’ businesses.",
            ...
            },
            {
              ...
              title: "Resources",
              description:
                "Stay ahead with expert insights on DevOps automation trends.",
              buttonText: "Explore Insights Now",
              href: "/resources",
            },
          ].map((item, index) => {
