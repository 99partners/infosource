    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <span className="text-sm font-medium text-blue-500">LLM Fine-Tuning Services</span>
        </div>
        ...
        <h1 className={`text-5xl md:text-7xl font-bold mb-6 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} text-black font-sans`}>
          ...
          <br />
          <span className="relative">Unlock <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">AI Potential<div className="absolute -bottom-2 left-0 w-full h-1 bg-blue-500 rounded-full transform scale-x-0 animate-[scale-x_1s_ease-out_1s_forwards]"></div></span></span>
        </h1>
        ...
        <p className={`text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto mb-12 leading-relaxed transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} font-sans`}>
          Maximize the capabilities of your AI models with Infosource’s comprehensive LLM fine-tuning services, customized to meet your business needs.
        </p>
        ...
        <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <Button variant="hero" size="xl" className="group relative overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400 hover:bg-blue-700 text-white font-sans">
            <span className="relative z-10 flex items-center gap-3">
              <MessageCircle className="w-5 h-5" />Optimize Your LLM Model
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </span>
          </Button>
          <Button variant="glass" size="xl" className="group bg-black/10 font-sans">
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <span className="text-sm font-medium text-blue-500">Our LLM Fine-Tuning Services</span>
          </div>
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Comprehensive <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">LLM Solutions</span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Leverage our extensive LLM fine-tuning solutions to enhance business performance.
          </p>
        </div>
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {[
            { icon: MessageCircle, text: "LLM Consultation for effective fine-tuning strategies." },
            { icon: Settings, text: "Custom Model Training for diverse industries." },
            { icon: CheckCircle, text: "Thorough Testing & Evaluation to streamline workflows." },
            { icon: Brain, text: "LLM Model Fine-Tuning for peak performance." },
            { icon: Database, text: "Data Selection & Preparation aligned with business goals." },
            { icon: Cloud, text: "LLM Model Integration across business models." }
          ].map((point, index) => {
...
const StatsSection = () => {
  ...
  const stats = [
    { value: "150%", label: "growth in LLM adoption 2022-2025", source: "AIPRM", icon: TrendingUp },
    { value: "$50B", label: "projected LLM market by 2030", source: "AIPRM", icon: BarChart3 },
    { value: "80%", label: "of enterprises using LLMs", source: "Forbes", icon: Users },
    { value: "35%", label: "CAGR for LLM services 2024-2030", source: "Grand View Research", icon: LineChart },
    { value: "60%", label: "of companies optimizing with LLMs", source: "Gartner", icon: Bot },
    { value: "85%", label: "of leaders prioritizing LLM performance", source: "World Economic Forum", icon: Monitor }
  ];
...
const CapabilitiesSection = () => {
  ...
  const capabilities = [
    { icon: Settings, title: "Hyperparameter Fine Tuning", description: "Optimize model performance with precise adjustments." },
    { icon: Brain, title: "Parameter Fine Tuning", description: "Enhance model accuracy with targeted parameter tuning." },
    { icon: FileText, title: "Instruction Fine-Tuning", description: "Tailor models for specific tasks with guided instructions." },
    ...
    { icon: Target, title: "Task-Specific Fine Tuning", description: "Customize LLMs for unique business applications." }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-blue-500">Types of LLM Fine-Tuning</span>
          </div>
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sans">
            Versatile <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Fine-Tuning Methods</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto font-sans">
            Our versatile fine-tuning methods ensure agile and effective solutions.
          </p>
        </div>
...
const TechnologiesSection = () => {
  ...
  const technologies = [
    { icon: Code, title: "Coding Languages", color: "from-blue-500 to-blue-700" },
    { icon: FileText, title: "Libraries", color: "from-green-500 to-green-700" },
    { icon: Brain, title: "Machine Learning Structures", color: "from-purple-500 to-purple-700" },
    { icon: Cloud, title: "Cloud Systems", color: "from-red-500 to-red-700" },
    { icon: BarChart3, title: "Tools for Model Evaluation", color: "from-indigo-500 to-indigo-700" }
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Advanced Tools for <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">LLM Fine-Tuning</span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            We leverage cutting-edge technologies to deliver innovative LLM solutions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {technologies.map((tech, index) => {
            ...
            return (
              <Card key={index} data-index={index} className={`tech-card group hover:shadow-lg transition-all duration-500 hover:scale-105 cursor-pointer ${isItemVisible ? 'animate-fade-in-up' : ''} bg-white`} style={{ animationDelay: `${index * 0.1}s` }}>
...
const ProcessSection = () => {
  ...
  const processes = [
    { icon: Database, title: "Data Processing", description: "Clean, organize, and format data for improved relevance and performance." },
    { icon: Brain, title: "Model Selection", description: "Choose a model based on functionality, complexity, and task scope." },
    { icon: Settings, title: "LLM Parameters Identification", description: "Define key parameters for seamless adaptation." },
    { icon: CheckCircle, title: "Model Testing & Refining", description: "Evaluate model performance and accuracy, refining until optimal." },
    { icon: Cloud, title: "Deployment & Monitoring", description: "Integrate and monitor models for ongoing improvements." }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <span className="text-sm font-medium text-blue-500">Our Fine-Tuning Process</span>
          </div>
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Strategic Approach to <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">LLM Fine-Tuning</span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            We follow a strategic approach to enhance LLM capabilities with a dedicated team.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-blue-800 to-blue-400 rounded-2xl p-8 text-white">
          ...
          <p className="text-lg mb-6 font-sans">Our global clients trust us to optimize their digital solutions.</p>
          <p className="text-blue-100 mb-8 font-sans">Transforming industries with tailored LLM solutions.</p>
          <Button variant="outline" className="border-white hover:bg-white hover:text-blue-600 font-sans">
            <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">
...
const WhyChooseSection = () => {
  ...
  const features = [
    { icon: Zap, title: "Technical Expertise", description: "Utilize cutting-edge resources to deliver innovative solutions." },
    { icon: Shield, title: "Ethical Development", description: "Ensure secure, bias-free, and sustainable AI solutions." }
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Why Infosource for <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">LLM Fine-Tuning</span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            We lead as a top LLM fine-tuning provider, customizing technology to enhance your workflows.
          </p>
        </div>
    ...
    <section ref={sectionRef} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold mb-6 text-black font-sans transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Transform Workflows with <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Infosource</span>
          </h2>
          <p className={`text-xl text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            Discover how our LLM fine-tuning services have redefined client workflows.
          </p>
        </div>
    ...
    <section className="py-24 bg-gradient-to-r from-blue-800 to-blue-400 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white font-sans">Ready to <span className="text-blue-200">Optimize</span> Your LLMs?</h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
            Partner with Infosource to unlock powerful LLM fine-tuning services that enhance your business performance.
          </p>
        </div>
        ...
        <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <Button variant="outline" size="xl" className="group border-white hover:bg-white hover:text-blue-600 font-sans">
          ...
          <Button variant="outline" size="xl" className="group border-white/50 hover:bg-white/10 font-sans">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:scale-105 transition-all duration-300">
            ...
            <p className="text-sm text-white/80 font-sans">Discover LLM opportunities for your business</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:scale-105 transition-all duration-300">
            <div className="w-12 h-12 rounded-lg bg-white/20 flex items-center justify-center mx-auto mb-4">
...
const LLMTestingFinetuning = () => {
  ...
  useEffect(() => {
    ...
    const items = document.querySelectorAll('.capability-card, .tech-card');
    items?.forEach((item) => observer.observe(item));
    return () => observer.disconnect();
  }, []);
