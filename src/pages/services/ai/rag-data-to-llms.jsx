    ...
    <section className="relative min-h-[calc(100vh-16rem)] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-24 pb-16 min-h-0">
        <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={0}>
          ...
          <span className="text-sm font-medium text-blue-500 font-sans">RAG as a Service</span>
        </div>
        <h1 className={`text-4xl md:text-5xl font-bold mb-6 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} text-black font-sans animate-on-scroll`} data-index={0}>
          <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Retrieval Augmented</span>
          <br />
          <span className="relative">Generation Solutions <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">with AI</span>
        ...
        <p className={`text-lg text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} font-sans animate-on-scroll`} data-index={0}>
          Transform extensive unstructured information into datasets ready for training to create responses that are precise in context using Retrieval Augmented Generation (RAG) within LLM.
        </p>
        <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={0}>
          <Button variant="hero" size="xl" className="group relative overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400 hover:bg-blue-700 text-white font-sans">
            <span className="relative z-10 flex items-center gap-3">
              <MessageCircle className="w-5 h-5" />Seek Advice from Our Specialists
          ...
          <Button variant="glass" size="xl" className="group bg-black/10 bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent hover:text-blue-600 font-sans">
            <Play className="w-5 h-5 group-hover:text-blue-600 transition-colors" />Discover RAG Benefits
          </Button>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={1}>
            <Brain className="w-4 h-4 text-blue-500" />
            <span className="text-sm font-medium text-blue-500 font-sans">Advantages of RAG</span>
          </div>
          <h2 className={`text-3xl font-bold mb-6 text-black font-sans transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            What Advantages Come from <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Adopting RAG?</span>
          </h2>
          <p className={`text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            This illustrates how RAG software can improve your enterprise operations.
          </p>
        </div>
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={3}>
          {[
            { icon: Target, text: "Increased Precision with updated, polished datasets." },
            { icon: Eye, text: "Superior Context Awareness for pertinent responses." },
            { icon: Zap, text: "Enhanced Operations with tailored chatbot dialogues." },
            { icon: TrendingUp, text: "Simple Expansion using external data sources." },
            { icon: Shield, text: "Responsibility for Data Origins to foster trust." }
          ].map((point, index) => {
...
const StatsSection = () => {
  ...
  const stats = [
    { value: "150%", label: "growth in RAG adoption from 2022-2025", source: "AIPRM", icon: TrendingUp },
    { value: "$50B", label: "projected RAG market revenue by 2030", source: "AIPRM", icon: BarChart3 },
    { value: "70%", label: "of enterprises using RAG for AI solutions", source: "Forbes", icon: Users },
    { value: "35%", label: "CAGR expected for RAG services 2024-2030", source: "Grand View Research", icon: TrendingUp },
    { value: "60%", label: "of companies enhancing chatbots with RAG", source: "Gartner", icon: Bot },
    { value: "80%", label: "of leaders prioritizing data transparency", source: "World Economic Forum", icon: Shield }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={1}>
            ...
            <span className="text-sm font-medium text-blue-500 font-sans">Key RAG Industry Stats</span>
          </div>
          <h2 className={`text-3xl font-bold mb-6 text-black font-sans transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            Key <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">RAG Industry Stats</span>
          </h2>
        </div>
...
const CapabilitiesSection = () => {
  ...
  const capabilities = [
    { icon: Search, title: "NLP Libraries & Structures", description: "Advanced NLP tools to process and understand complex data." },
    { icon: Database, title: "Vector Storage Systems", description: "Efficient storage for fast retrieval of relevant data." },
    { icon: Settings, title: "AI Frameworks", description: "Robust frameworks for building scalable RAG solutions." },
    { icon: Cloud, title: "Cloud-Based Storage", description: "Secure and scalable cloud storage for data management." },
    { icon: FileText, title: "Database Management Systems", description: "Organized systems for efficient data querying." },
    { icon: Zap, title: "Container Tools", description: "Tools for deploying and managing RAG applications." }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={1}>
            ...
            <span className="text-sm font-medium text-blue-500 font-sans">Our RAG Capabilities</span>
          </div>
          <h2 className={`text-3xl font-bold mb-6 text-black font-sans transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            Infosource's <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">RAG Capabilities</span>
          </h2>
          <p className={`text-lg text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            Tools that enable us to provide superior RAG services.
          </p>
        </div>
...
const ProcessSection = () => {
  ...
  const processes = [
    { icon: Search, title: "Spotting Needs", description: "Review chances for RAG adoption and data standard for obtaining pertinent details." },
    { icon: Database, title: "Data Collection & Organization", description: "Assemble data from diverse sources and format it for easy retrieval." },
    { icon: Settings, title: "Choosing Retrieval & Creation Models", description: "Select models suited to your application's specific needs." },
    { icon: Zap, title: "Merging the Models", description: "Combine retrieval and creation models for effective query handling." },
    { icon: CheckCircle, title: "Assessment & Improvement", description: "Evaluate and refine the RAG solution using key performance indicators." }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          <div className={`inline-flex items-center gap-2 bg-blue-500/10 border border-blue-500/20 rounded-full px-4 py-2 mb-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={1}>
            ...
            <span className="text-sm font-medium text-blue-500 font-sans">Our RAG Process</span>
          </div>
          <h2 className={`text-3xl font-bold mb-6 text-black font-sans transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            Our Defined Method for <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Adopting RAG</span>
          </h2>
          <p className={`text-lg text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            We guarantee smooth RAG incorporation into your current setup.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-blue-800 to-blue-400 rounded-xl p-8 text-white">
          ...
          <p className="text-lg mb-6 font-sans">Our accomplished initiatives customized to client demands</p>
          <p className="text-blue-100 mb-8 font-sans">How we supported clients in incorporating optimal digital solutions.</p>
...
const WhyChooseSection = () => {
  ...
  const features = [
    { icon: Target, title: "Services Centered on Clients", description: "We optimize teamwork, ease interactions, and prioritize client needs." },
    { icon: Award, title: "Technical Proficiency", description: "Our team crafts innovative RAG solutions for enduring client success." }
  ];

  const achievements = [
    { value: "12+", label: "Years of Experience", icon: Clock },
    { value: "800+", label: "Happy Clients", icon: Users },
    { value: "300+", label: "Skilled AI Professionals", icon: Star },
    { value: "1200+", label: "Completed Projects", icon: CheckCircle },
    { value: "5", label: "Proprietary Products", icon: Settings },
    { value: "92%", label: "Client Retention Rate", icon: TrendingUp }
  ];
    ...
    <section ref={sectionRef} className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <h2 className={`text-3xl font-bold mb-6 text-black font-sans transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            Why Choose Infosource for <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">RAG Solutions</span>
          </h2>
          <p className={`text-lg text-gray-600 max-w-3xl mx-auto font-sans transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
            Our group delivers high-standard services to enhance your operations.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
      ...
      <div className="max-w-7xl mx-auto px-6 text-center">
        <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={1}>
          ...
          <h2 className="text-3xl font-bold mb-6 text-black font-sans">
            Ready to <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Transform</span> with RAG?
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
            Partner with Infosource to leverage Retrieval Augmented Generation for precise, context-aware AI solutions.
          </p>
        </div>
        <div className={`flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 transition-all duration-1000 delay-300 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={2}>
          ...
          <Button variant="glass" size="xl" className="group bg-black/10 bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent hover:text-blue-600 font-sans">
            <Calendar className="w-5 h-5" />Develop a Tailored Solution
          </Button>
        </div>
        <div className={`grid grid-cols-1 md:grid-cols-3 gap-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'} animate-on-scroll`} data-index={3}>
          <Card className="bg-black/5 p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105">
            <CardContent>
              ...
              <p className="text-sm text-gray-600 font-sans">Start a conversation about your RAG project</p>
            </CardContent>
          </Card>
          <Card className="bg-black/5 p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105">
            <CardContent>
              ...
              <p className="text-sm text-gray-600 font-sans">Discover RAG opportunities for your organization</p>
            </CardContent>
          </Card>
          <Card className="bg-black/5 p-6 rounded-xl hover:shadow-lg transition-all duration-300 hover:scale-105">
            <CardContent>
