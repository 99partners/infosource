...
const TechStackSection = () => {
  ...
  const technologies = [
    ...
    { icon: Settings, title: "Python", color: "from-green-500 to-green-700" },
    { icon: Settings, title: "PHP", color: "from-indigo-500 to-indigo-700" },
    { icon: Settings, title: "AngularJS", color: "from-red-500 to-red-700" },
    { icon: Settings, title: "ReactJS", color: "from-blue-500 to-blue-700" },
    { icon: Settings, title: "NodeJS", color: "from-green-500 to-green-700" },
    { icon: Settings, title: "NextJS", color: "from-black-500 to-black-700" },
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-white font-sans">
            Transforming <span className="text-blue-200">Industries</span> with Product Engineering
          </h2>
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
            Discover how Infosource’s product engineering services drive success across SaaS, real estate, energy, BFSI, logistics, and healthcare.
          </p>
        </div>
        <div
          ...
          {[
            {
              icon: Star,
              title: "Case Studies",
              description: "Explore our portfolio, including a SaaS collaboration platform, Akaree’s eTendering, Step-Up’s waste management app, Cardex’s crypto platform, and more.",
              buttonText: "Explore Our Case Studies",
            },
            {
              icon: TrendingUp,
              title: "Industries",
              description: "Transforming SaaS, real estate, energy, BFSI, logistics, and healthcare with innovative product solutions.",
              buttonText: "Get Your Custom Solution",
            },
            {
              icon: Users,
              title: "Testimonials",
              description: "Hear from clients about our transformative product engineering services.",
              buttonText: "Read Client Testimonials",
            },
            {
              icon: CheckCircle,
              title: "Resources",
              description: "Stay updated with insights on product engineering trends and strategies.",
