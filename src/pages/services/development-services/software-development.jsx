  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
        ...
        >
          Unlock new opportunities with Infosource’s tailored software development services, designed to meet your unique business needs.
        </p>
        <div
    ...
    <section ref={sectionRef} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Infosource delivers innovative, scalable, and secure software solutions to empower businesses of all sizes.
          </p>
        </div>
        <div
        ...
        >
          {[
            {
              icon: Code,
              text: "Custom API Development: Seamlessly connect with customers and vendors through tailored API integration.",
            },
            {
              icon: Users,
              text: "Enterprise Software Development: Scalable solutions to automate and optimize business processes.",
            },
            {
              icon: Target,
              text: "Software Consulting: Expert guidance to design user-friendly, market-ready software solutions.",
            },
            {
              icon: Star,
              text: "Software Product Development: Stable, engaging, and cost-effective software products.",
            },
            {
              icon: CheckCircle,
              text: "Software Integration: Integrate cutting-edge technologies to enhance functionality.",
            },
            {
              icon: Zap,
              text: "Custom Web Development: Holistic web solutions tailored to your business objectives.",
            },
            {
              icon: Cloud,
              text: "Cloud Application Development: Scalable, secure cloud-based applications for flexible systems.",
            },
            {
              icon: Settings,
              text: "Legacy Software Modernization: Revamp legacy systems with updated platforms and enhanced UX.",
            },
            {
              icon: CheckCircle,
              text: "Software Testing: Ensure robust, high-quality software through rigorous testing.",
            },
          ].map((point, index) => {
...
const TechStackSection = () => {
  ...
  const technologies = [
    ...
    { icon: Settings, title: "Java", color: "from-green-500 to-green-700" },
    { icon: Settings, title: "Python", color: "from-purple-500 to-purple-700" },
    { icon: Settings, title: "PHP", color: "from-red-500 to-red-700" },
    { icon: Settings, title: "AngularJS", color: "from-indigo-500 to-indigo-700" },
    { icon: Settings, title: "ReactJS", color: "from-blue-500 to-blue-700" },
    { icon: Settings, title: "NodeJS", color: "from-green-500 to-green-700" },
    { icon: Settings, title: "NextJS", color: "from-purple-500 to-purple-700" },
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Our advanced tools drive transformative software solutions.
          </p>
        </div>
...
const ProcessSection = () => {
  ...
  const processes = [
    ...
    },
    {
      icon: Settings,
      title: "Design",
      description: "Develop architecture, designs, and prototypes.",
    },
    {
      icon: Code,
      title: "Development",
    ...
    },
    {
      icon: CheckCircle,
      title: "Testing",
      description: "Perform quality assurance and resolve issues.",
    },
    {
      icon: ArrowRight,
      title: "Deployment",
      description: "Launch beta and live versions of the software.",
    },
    {
      icon: Clock,
      title: "Maintenance",
    ...
    <section ref={sectionRef} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            A streamlined process to deliver software aligned with your goals.
          </p>
        </div>
        ...
        <div className="text-center bg-gradient-to-r from-blue-800 to-blue-400 rounded-2xl p-8 text-white">
          ...
          <p className="text-lg mb-6 font-sans">
            Review our notable software development case studies
          </p>
...
const WhyChooseSection = () => {
  ...
  const features = [
    {
      icon: Target,
      title: "Transparency",
      description: "Foster trust through open communication and collaborative partnerships.",
    },
    {
      icon: CheckCircle,
      title: "Quality Solutions",
      description: "Deliver precise, client-focused products through rigorous quality checks.",
    },
    {
      icon: Star,
      title: "Domain Expertise",
      description: "Leverage our vetted team’s extensive industry experience.",
    },
    {
      icon: Zap,
      title: "Cost Efficiency",
      description: "Access top talent at competitive rates, optimizing your budget.",
    },
  ];
  ...
  const achievements = [
    ...
    { value: "2", label: "Global Locations", icon: Target },
  ];
    ...
    <section ref={sectionRef} className="py-24 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          >
            Choose us for reliable, high-quality software development solutions.
          </p>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
            Discover how Infosource’s software solutions drive business success across industries.
          </p>
        </div>
        <div
          ...
          {[
            {
              icon: Star,
              title: "Case Studies",
              description: "Review our notable software development case studies and observe how we drive business success.",
              buttonText: "View Our Case Studies",
            },
            {
              icon: TrendingUp,
              title: "Industries",
              description: "Software development achievements across sectors, transforming businesses with innovative solutions.",
              buttonText: "Arrange a Complimentary Consultation",
            },
            {
              icon: Users,
              title: "Testimonials",
              description: "Our clients express how Infosource’s software solutions have transformed their businesses.",
              buttonText: "Read Client Testimonials",
            },
            {
              icon: CheckCircle,
              title: "Resources",
              description: "Explore blogs, trends, and advice to master software development.",
              buttonText: "Access Software Development Blogs",
            },
          ].map((item, index) => {
