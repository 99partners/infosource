      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 transition-all duration-1000 delay-600 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          {[
            ...
            { icon: Users, text: "Healthcare providers are leveraging AI for better decision-making." },
            { icon: Shield, text: "Technological advancements and ethical frameworks fuel AI adoption." }
          ].map((point, index) => {
...
const StatsSection = () => {
  ...
  const stats = [
    { value: "233%", label: "growth in the healthcare AI market between 2020 and 2023", source: "AIPRM", icon: TrendingUp },
    { value: "$102B", label: "in projected AI healthcare revenue by 2030", source: "AIPRM", icon: BarChart3 },
    { value: "79%", label: "of healthcare institutions are already implementing AI", source: "Healthcare IT News", icon: Users },
    { value: "38%", label: "CAGR expected from 2024 to 2030", source: "Horizon Grand View Research", icon: LineChart },
    { value: "29%", label: "of providers focus AI investments on clinical support tools", source: "AIPRM", icon: Stethoscope },
    { value: "60%", label: "of industry leaders follow AI governance policies", source: "World Economic Forum", icon: Shield }
  ];
...
const CapabilitiesSection = () => {
  ...
  const capabilities = [
    { icon: Stethoscope, title: "AI for Clinical Support Systems", description: "Intelligent systems that assist healthcare professionals in diagnosis and treatment decisions." },
    { icon: LineChart, title: "Predictive Health Analytics", description: "Advanced analytics to forecast health trends and patient outcomes." },
    { icon: Eye, title: "Advanced Imaging & Radiology", description: "AI-powered medical imaging analysis for accurate diagnostics." },
    { icon: Bot, title: "AI-Powered Chatbots & Virtual Care", description: "Intelligent virtual assistants for patient engagement and support." },
    { icon: Monitor, title: "Remote Patient Monitoring Tools", description: "Real-time monitoring solutions for continuous patient care." },
    { icon: Settings, title: "Workflow Optimization Solutions", description: "Streamlined healthcare operations through intelligent automation." },
    { icon: User, title: "Personalized Care & Medication Insights", description: "Tailored treatment plans based on individual patient data." },
    { icon: Smartphone, title: "Custom Patient Engagement Platforms", description: "Digital platforms to enhance patient experience and engagement." }
  ];
...
const SolutionsSection = () => {
  ...
  const solutions = [
    { icon: Monitor, title: "Telemedicine", description: "AI-enabled telehealth facilitates virtual assessments, personalized care advice, and real-time diagnostics through secure consultations." },
    { icon: Pill, title: "Drug Development", description: "By processing complex biomedical data, AI accelerates the drug discovery process—identifying compounds, predicting interactions, and suggesting effective formulations." },
    { icon: FlaskConical, title: "Life Sciences", description: "AI tools empower research in biotech and genomics, helping scientists unlock insights and develop innovative treatments faster." },
    { icon: FileText, title: "Patient Data Management", description: "Automated AI systems handle patient records, streamline data processing, and create tailored health plans for improved outcomes." },
    { icon: Users, title: "Workforce Optimization", description: "AI analyzes staffing needs and patient inflow to create efficient schedules, reduce fatigue, and enhance workforce productivity." },
    { icon: Database, title: "Healthcare Data Handling", description: "From entry to analysis, AI automates the entire data lifecycle, ensuring clean, structured, and reliable information for providers." },
    { icon: AlertTriangle, title: "Epidemic Forecasting", description: "Predictive AI tools evaluate current trends and historical data to anticipate disease outbreaks and assist in rapid response planning." },
    { icon: Search, title: "Research Acceleration", description: "AI enables researchers to explore large datasets, formulate hypotheses faster, and speed up the path to treatment discoveries." }
  ];
...
const ProcessSection = () => {
  ...
  const processes = [
    { icon: Database, title: "Data-Centric Development", description: "We utilize massive healthcare datasets to build AI systems capable of insightful analysis and accurate predictions." },
    { icon: Shield, title: "Responsible AI Practice", description: "Our AI projects are developed with a commitment to fairness, transparency, and ethical AI design." },
    { icon: CheckCircle, title: "Compliance-First Approach", description: "Infosource adheres to global regulations including HIPAA and GDPR to ensure full patient data protection." },
    { icon: Users, title: "Clinician + AI Synergy", description: "We design AI tools that work with healthcare professionals—augmenting expertise, not replacing it." }
  ];
...
const WhyChooseSection = () => {
  ...
  const features = [
    { icon: Target, title: "Custom-Fit Solutions", description: "We deliver bespoke AI products tailored to healthcare providers' specific goals and operational needs." },
    { icon: Award, title: "Proven Experience", description: "With decades of industry knowledge and a team of seasoned experts, we ensure successful AI implementation across various healthcare environments." }
  ];
