        ...
        <section className="relative min-h-[calc(100vh-16rem)] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-24 pb-16 min-h-0">
            ...
            <h1
              ...
              data-index={0}
            >
              Innovate <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">BFSI</span>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6 text-black font-sans">
                Advanced <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">BFSI Solutions</span>
              </h2>
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6 text-black font-sans">
                Exceptional <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">BFSI Solutions</span>
              </h2>
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6 text-black font-sans">
                Technologies <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Powering BFSI</span>
              </h2>
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6 text-black font-sans">
                Why Partner with <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">Infosource?</span>
              </h2>
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6 text-black font-sans">
                Beyond <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">BFSI</span>
              </h2>
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <section className="py-12 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-3xl font-bold mb-6 text-black font-sans">
                Transform <span className="bg-gradient-to-r from-blue-800 to-blue-400 bg-clip-text text-transparent">BFSI</span> with Infosource
              </h2>
            ...
            >
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 font-sans">Discuss your BFSI project with our experts.</p>
                </CardContent>
              </Card>
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 font-sans">Explore opportunities for your financial institution.</p>
                </CardContent>
              </Card>
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
