        ...
        <section className="relative min-h-[calc(100vh-16rem)] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-24 pb-16 min-h-0">
            ...
            <p
              ...
              data-index={0}
            >
              Discover premium banking and financial software development
              services at Infosource, designed to optimize and transform the
              BFSI sector with secure, innovative solutions.
            </p>
            <div
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed font-sans">
                We deliver innovative BFSI software tailored to client needs,
                utilizing cutting-edge technologies to drive growth and ensure
                compliance.
              </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Intuitive Android/iOS apps with robust security and cross-platform compatibility.",
                  },
                  {
                    icon: Package,
                    title: "Loan Management Software",
                    description:
                      "Comprehensive systems to enhance service quality and operational efficiency.",
                  },
                  {
                    icon: Users,
                    title: "Neo Banking Platforms",
                    description:
                      "Digital banking portals for seamless fund transfers, payments, and lending.",
                  },
                  {
                    icon: Star,
                    title: "Digital Wallet Solutions",
                    description:
                      "Secure mobile payment technologies for convenient transactions.",
                  },
                  {
                    icon: Shield,
                    title: "Insurance Claim Software",
                    description:
                      "Automated systems for streamlined claim processing and evaluations.",
                  },
                  {
                    icon: Clock,
                    title: "Trading Platforms",
                    description:
                      "Fast, reliable platforms with real-time quotes and advanced analytics.",
                  },
                ].map((item, index) => {
                ...
                {[
                  {
                    ...
                    description:
                      "A platform providing credit access to underserved populations in Tanzania for financial inclusion.",
                  },
                  {
                    title: "Youth Financial App",
                    description:
                      "An eWallet in Egypt with parental controls, processed via the National Bank of Egypt.",
                  },
                  {
                    title: "Crypto Trading Platform",
                    description:
                      "A global exchange with advanced analytics and robust security for minimal-risk trading.",
                  },
                ].map((project, index) => (
                  <Card
                    key={index}
              ...
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed font-sans">
                    We leverage leading languages and tools to build secure,
                    scalable, and high-performance BFSI software solutions.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  <p className="text-lg text-gray-600 leading-relaxed font-sans">
                    Tap into Infosource’s digital expertise to build innovative
                    BFSI solutions that optimize operations and drive business
                    growth.
                  </p>
                </CardContent>
              </Card>
            ...
            >
              ...
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed font-sans">
                    Our expertise empowers businesses across diverse sectors
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
                Partner with Infosource to create secure, innovative BFSI
                software that optimizes operations and enhances customer
                experiences.
              </p>
            </div>
            <div
            ...
            >
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 font-sans">
                    Discuss your BFSI project with our experts.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 font-sans">
                    Explore opportunities for your financial institution.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
