                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    {[
                      ...
                      "Sports & Gaming – Engaging Sports Apps",
                      "Real Estate – Smart PropTech Tools",
                      "SaaS – Scalable SaaS Products",
                      "Media & Entertainment – Seamless Content Platforms",
                      "Fintech – Innovative Financial Software",
                      "Healthcare – Intelligent Healthtech Solutions",
                      "Education – Next-Gen EdTech Platforms",
