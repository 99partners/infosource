        ...
        <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-24 pb-16 min-h-0">
            ...
            <h1
              ...
              data-index={0}
            >
              Elevate <span className="text-blue-500 relative">Sports & Gaming<div className="absolute -bottom-2 left-0 w-full h-1 bg-blue-500 rounded-full transform scale-x-0 animate-[scale-x_1s_ease-out_1s_forwards]"></div></span>
            </h1>
            <p
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sans">
                Custom <span className="text-blue-500">Sports & Gaming Solutions</span>
              </h2>
        ...
        <section className="py-24 bg-white">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sans">
                Driving <span className="text-blue-500">Innovation in Sports</span>
              </h2>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sans">
                Technologies <span className="text-blue-500">Powering Sports Apps</span>
              </h2>
        ...
        <section className="py-24 bg-gray-50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sans">
                Beyond <span className="text-blue-500">Sports & Gaming</span>
              </h2>
              <Card className="p-8 rounded-2xl max-w-4xl mx-auto shadow-lg hover:shadow-xl transition-shadow duration-300 bg-black/5">
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <section className="relative min-h-[calc(100vh-4rem)] flex items-center justify-center overflow-hidden bg-gradient-to-r from-blue-800 to-blue-400">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center pt-24 pb-16 min-h-0">
            ...
            >
              ...
              <h2 className="text-4xl md:text-6xl font-bold mb-6 text-black font-sans">
                Build Your <span className="text-blue-500">Sports App</span> with Infosource
              </h2>
            ...
            >
              <Card className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:scale-105 transition-all duration-300">
                <CardContent>
                  ...
                  <p className="text-sm text-black/80 font-sans">Discuss your sports app project with our experts.</p>
                </CardContent>
              </Card>
              <Card className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:scale-105 transition-all duration-300">
                <CardContent>
                  ...
                  <p className="text-sm text-black/80 font-sans">Explore opportunities for your sports solution.</p>
                </CardContent>
              </Card>
              <Card className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-6 hover:scale-105 transition-all duration-300">
                <CardContent>
