        ...
        <section className="relative min-h-[calc(100vh-16rem)] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 text-center pt-24 pb-16 min-h-0">
            ...
            <p
              ...
              data-index={0}
            >
              Revolutionize online shopping with Infosource’s AI solutions —
              from personalized experiences to intelligent automation, we
              empower ecommerce businesses to thrive.
            </p>
            <div
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed font-sans">
                Artificial Intelligence is transforming ecommerce by delivering
                personalized shopping experiences, optimizing operations, and
                boosting ROI.
              </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Match products to user preferences for higher conversions.",
                  },
                  {
                    icon: Search,
                    title: "Smart Search Optimization",
                    description:
                      "Enhance product discovery with intelligent search.",
                  },
                  {
                    icon: Bot,
                    title: "24/7 Customer Support",
                    description:
                      "AI chatbots provide seamless, round-the-clock assistance.",
                  },
                  {
                    icon: BarChart,
                    title: "Predictive Insights",
                    description:
                      "Anticipate customer needs with data-driven forecasts.",
                  },
                ].map((item, index) => {
                ...
                {[
                  {
                    value: 22.4,
                    suffix: "B",
                    description: "Projected AI in ecommerce market by 2028",
                    source: "SellersCommerce",
                  },
                  {
                    value: 35,
                    suffix: "%",
                    description: "Amazon’s revenue from AI recommendations",
                    source: "McKinsey & Company",
                  },
                  {
                    value: 69,
                    suffix: "%",
                    description: "Shoppers open to AI-assisted product search",
                    source: "Salesforce",
                  },
                  {
                    value: 78,
                    suffix: "%",
                    description: "Ecommerce brands using AI chatbots",
                    source: "Socialchamp",
                  },
                  {
                    value: 26,
                    suffix: "%",
                    description: "Rise in conversion rates with AI suggestions",
                    source: "Big Sur AI",
                  },
                  {
                    value: 60,
                    suffix: "%",
                    description: "Ecommerce leaders using generative AI",
                    source: "Salesforce",
                  },
                ].map((stat, index) => (
                  <Card
              ...
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed font-sans">
                    Our AI-powered tools are designed to transform your
                    ecommerce ecosystem, driving conversions, enhancing customer
                ...
                {[
                  {
                    ...
                    description:
                      "Enhance search accuracy with NLP and image recognition.",
                  },
                  {
                    icon: ShoppingCart,
                    title: "Marketing Automation",
                    description:
                      "Optimize ad targeting and personalize campaigns for better ROI.",
                  },
                  {
                    icon: Package,
                    title: "Inventory Management",
                    description:
                      "Predict demand and automate replenishment to reduce losses.",
                  },
                  {
                    icon: MessageSquare,
                    title: "Customer Support",
                    description:
                      "AI chatbots provide 24/7 assistance for improved satisfaction.",
                  },
                  {
                    icon: Cpu,
                    title: "Voice Commerce",
                    description:
                      "Enable shopping via smart speakers and voice assistants.",
                  },
                  {
                    icon: Shield,
                    title: "Fraud Detection",
                    description:
                      "Real-time monitoring to protect transactions and customer data.",
                  },
                  ...
                  return (
                    <Card
                      key={index}
                      className={`hover:shadow-lg transition-all duration-500 hover:scale-105 bg-black/5 rounded-xl ${
                        visibleItems.includes(21 + index)
                          ? "opacity-100 translate-y-0"
                          : "opacity-0 translate-y-8"
                      } animate-on-scroll`}
                      data-index={21 + index}
              ...
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  ...
                  <p className="text-lg text-gray-600 leading-relaxed font-sans">
                    ...
                    high-performance AI solutions for ecommerce businesses.
                  </p>
                </CardContent>
              </Card>
            </div>
                ...
                {[
                  {
                    ...
                    description:
                      "AI-driven unique shopping experiences based on customer behavior.",
                  },
                  {
                    icon: BarChart,
                    title: "Demand Forecasting",
                    description:
                      "Predict inventory needs to minimize waste and maximize sales.",
                  },
                  {
                    icon: Search,
                    title: "Smart Search Technology",
                    description:
                      "Enable fast, intuitive product discovery with visual and voice search.",
                  },
                  {
                    icon: Shield,
                    title: "Revenue Protection",
                    description:
                      "Real-time fraud detection and intelligent pricing strategies.",
                  },
                ].map((approach, index) => {
                  ...
                  return (
                    <Card
                      key={index}
                      className={`hover:shadow-lg transition-all duration-500 hover:scale-105 bg-black/5 rounded-xl ${
                        visibleItems.includes(38 + index)
                          ? "opacity-100 translate-y-0"
                          : "opacity-0 translate-y-8"
                      } animate-on-scroll`}
                      data-index={38 + index}
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
                {[
                  ...
                  <Card
                    key={index}
                    className={`hover:shadow-lg transition-all duration-500 bg-black/5 rounded-xl ${
                      visibleItems.includes(43 + index)
                        ? "opacity-100 translate-y-0"
                        : "opacity-0 translate-y-8"
                    } animate-on-scroll`}
                    data-index={43 + index}
              ...
              <Card className="p-8 rounded-xl max-w-4xl mx-auto bg-black/5">
                <CardContent>
                  <p className="text-lg text-gray-600 leading-relaxed font-sans">
                    Partner with Infosource to leverage our industry-specific
                    expertise and results-driven AI solutions tailored for
                    ecommerce growth and customer satisfaction.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed mb-12 font-sans">
                Connect with Infosource to discover how our AI solutions can
                drive conversions, enhance customer experiences, and streamline
            ...
            >
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 font-sans">
                    Discuss your ecommerce AI project with our experts.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
                <CardContent>
                  ...
                  <p className="text-sm text-gray-600 font-sans">
                    Explore AI opportunities for your ecommerce business.
                  </p>
                </CardContent>
              </Card>
              <Card className="bg-black/5 rounded-xl p-6 hover:shadow-lg transition-all duration-300 hover:scale-105">
